...
const BestUserContainer = ({navigation, place, name, count, avatarPath}) => {
    return (
        <TouchableOpacity onPress={()=>navigation.navigate('Profile', {type: 2, userId: 222})} style={bestUsersStyles().userContainer}>
...
const BestUsers = ({navigation}) => {
    ...
    return (
        <View>
            ...
            <BestUserContainer navigation={navigation} place={3} name='Tezt' count={34831}
            ...
            <BestUserContainer navigation={navigation} place={'1k'} name='Tezt' count={1}
                               avatarPath={'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Wikipedia-logo-v2.svg/200px-Wikipedia-logo-v2.svg.png'}/>
        </View>
    );
}
